...
public class MeadowSlimeEntity extends Monster implements GeoEntity {
    ...
    public static final RawAnimation ATTACK = RawAnimation.begin().thenLoop("animation.meadow_slime.attack");
//    public static final RawAnimation REST = RawAnimation.begin().thenLoop("animation.meadow_slime.rest");
//    public static final RawAnimation RESTING = RawAnimation.begin().thenLoop("animation.meadow_slime.resting");
//    public static final RawAnimation AWAKEN = RawAnimation.begin().thenLoop("animation.meadow_slime.awaken");
